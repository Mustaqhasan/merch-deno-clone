import { addItemToCart, getCart } from "@/redux/cart/cart.action";
import { addItemToCartAPI } from "@/redux/cart/cart.api";
...
{/* 
        ...
        <Button w="full" colorScheme="blackAlpha" onClick={handleAddItem}>
          Add to Cart
        </Button>
      </Box>
